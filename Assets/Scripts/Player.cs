    ...
    private void HandelMovement()
    {
        ...
        if (!CanMove)
        {
            ...
            else 
            {
                ...
                CanMove = (moveDir.y < -.5f || moveDir.y < +.5f) && !Physics.CapsuleCast(transform.position, transform.position + Vector3.up * playerHeight, playerRadius, moveDirZ, moveDistance);
